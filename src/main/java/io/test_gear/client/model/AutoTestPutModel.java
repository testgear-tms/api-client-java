...
public class AutoTestPutModel {
  ...
  **/
  ...
  @ApiModelProperty(example = "ab0f4e0e-441c-40a0-8c59-4e5cd37bcc16", value = "Used for search autotest. If value equals Guid mask filled with zeros, search will be executed using ExternalId")
