...
public class TestResultHistoryReportModel {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ab0f4e0e-441c-40a0-8c59-4e5cd37bcc16", value = "If test run was stopped, this property equals identifier of user who stopped it.Otherwise, the property equals identifier of user who created the test result")
